                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_rekammedis"
                                        value="{{ $rekammedispasien->id_rekammedis }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 @error('id_pasien') is-invalid @enderror"
                                        ...
                                        @foreach ($pasien as $p)
                                            <option value="{{ $p->id }}"
                                                {{ $p->id == $rekammedispasien->id_pasien ? 'SELECTED' : '' }}>
                                                {{ $p->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_pasien')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('id_dokter') is-invalid @enderror"
                                        style="width: 100%;" id="dokter" name="id_dokter" <option value="">Pilih
                                        Dokter</option>
                                        @foreach ($dokter as $d)
                                            <option
                                                value="{{ $d->id }}"{{ $p->id == $rekammedispasien->id_dokter ? 'SELECTED' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal" value="{{ $rekammedispasien->tanggal }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="diagnosa" value="{{ $rekammedispasien->diagnosa }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" class="form-control @error('fasilitas') is-invalid @enderror" id="tindakan_medis"
                                        id="tindakan_medis" name="tindakan_medis" rows="3"> {{ $rekammedispasien->tindakan_medis }}</textarea>

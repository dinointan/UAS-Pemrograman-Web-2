                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_kamar" id="jenis_kamar"
                                        ...
                                        <option value="svip" {{ $kamar->jenis_kamar == 'svip' ? 'selected' : '' }}>Kamar
                                            SVIP
                                        </option>
                                        <option value="vip" {{ $kamar->jenis_kamar == 'vip' ? 'selected' : '' }}>Kamar
                                            VIP
                                        </option>
                                        <option value="kelas1" {{ $kamar->jenis_kamar == 'kelas1' ? 'selected' : '' }}>
                                            Kamar
                                            Kelas 1
                                        </option>
                                        <option value="kelas2" {{ $kamar->jenis_kamar == 'kelas2' ? 'selected' : '' }}>
                                            Kamar
                                            Kelas 2
                                        </option>
                                        <option value="kelas3" {{ $kamar->jenis_kamar == 'kelas3' ? 'selected' : '' }}>
                                            Kamar
                                            Kelas 3
                                        </option>
                                        <option value="imc" {{ $kamar->jenis_kamar == 'imc' ? 'selected' : '' }}>Kamar
                                            IMC
                                        </option>
                                        <option value="icu" {{ $kamar->jenis_kamar == 'icu' ? 'selected' : '' }}>Kamar
                                            ICU
                                        </option>
                                        <option value="nicu" {{ $kamar->jenis_kamar == 'nicu' ? 'selected' : '' }}>Kamar
                                            NICU
                                        </option>
                                    </select>
                                    @error('jenis_kamar')
                                ...
                                <div class="form-group">
                                    ...
                                    <img style="width: 100px" src="{{ asset('assets/images/kamar/' . $kamar->foto) }}"
                                        alt="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" class="form-control @error('fasilitas') is-invalid @enderror" id="nama_kamar"
                                        id="fasilitas" name="fasilitas" rows="3"> {{ $kamar->fasilitas }} </textarea>
